...
class RepoPaginationResultRepoItemSummary(BaseModel):
    """
    RepoPaginationResultRepoItemSummary
    """ # noqa: E501
    items: Optional[List[RepoItemSummary]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [RepoItemSummary.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "page": obj.get("page"),
