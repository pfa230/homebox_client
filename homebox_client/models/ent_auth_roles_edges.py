...
class EntAuthRolesEdges(BaseModel):
    """
    EntAuthRolesEdges
    """ # noqa: E501
    token: Optional[EntAuthTokens] = Field(default=None, description="Token holds the value of the token edge.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "token": EntAuthTokens.from_dict(obj["token"]) if obj.get("token") is not None else None
        })
        return _obj

from homebox_client.models.ent_auth_tokens import EntAuthTokens
# TODO: Rewrite to not use raise_errors
EntAuthRolesEdges.model_rebuild(raise_errors=False)
