...
class RepoMaintenanceEntryWithDetails(BaseModel):
    """
    RepoMaintenanceEntryWithDetails
    """ # noqa: E501
    completed_date: Optional[StrictStr] = Field(default=None, alias="completedDate")
    ...
    scheduled_date: Optional[StrictStr] = Field(default=None, alias="scheduledDate")
    __properties: ClassVar[List[str]] = ["completedDate", "cost", "description", "id", "itemID", "itemName", "name", "scheduledDate"]
