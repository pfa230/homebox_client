...
T = TypeVar("T", bound="EntAuthTokensEdges")



@_attrs_define
class EntAuthTokensEdges:
    """ 
        Attributes:
    ...
    roles: Union[Unset, 'EntAuthRoles'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_roles,  Unset):
            ...
            roles = EntAuthRoles.from_dict(_roles)
        ...
        ent_auth_tokens_edges = cls(
            roles=roles,
            user=user,
        )


        ent_auth_tokens_edges.additional_properties = d
        return ent_auth_tokens_edges
