...
class V1TokenResponse(BaseModel):
    ...
    V1TokenResponse
    """ # noqa: E501
    attachment_token: Optional[StrictStr] = Field(default=None, alias="attachmentToken")
    expires_at: Optional[StrictStr] = Field(default=None, alias="expiresAt")
    token: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["attachmentToken", "expiresAt", "token"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attachmentToken": obj.get("attachmentToken"),
